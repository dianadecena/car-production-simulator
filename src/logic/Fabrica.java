...
public class Fabrica {
    ...
    public static int cantRuedas, cantParabrisas, cantMotores;
    ...
    public void inicializar(){
        ...
        //Creación del jefe
        this.jefe = new Jefe(this.parametros.getDia(), cantDias, mutexModifDias, this.parametros);
        
        //Creación gerente
        this.gerente = new Gerente(this.parametros.getDia(), cantDias, mutexModifDias, mutexCarrosTerminados);
        
        this.crearProductores();
        this.crearEnsambladores();
        
        this.carrosTerminados = 0;
       /* this.cantRuedas = parametros.getMaxAlmacenR();
        this.cantParabrisas = parametros.getMaxAlmacenP();
        this.cantMotores = parametros.getMaxAlmacenM();*/
    }
    ...
    public void crearProductores(){
        ...
        for(int i=0; i<this.parametros.getInitProductoresR(); i++){
            ...
            this.sHayRuedas, this.mutexAlmacenR, this.parametros.getMaxAlmacenR());
        }
    ...
    public void startThreads(){
        ...
        this.comenzarJefe();
        this.comenzarGerente();
    }

    public static int getCarrosTerminados() {
        return carrosTerminados;
    }

    public static void setCarrosTerminados(int carrosTerminados) {
